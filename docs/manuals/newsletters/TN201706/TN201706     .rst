...
**5447 Option to align W2H page LEFT or CENTER**

New Display Option in the “Miscellaneous” settings page to allow left
...
**5477 Option to switch R2L or L2R**

A new display option in the miscellaneous settings panel to define how
text is displayed in the W2H page. The options are “Right to Left” or
“Left to Right (Default)”.

As an example in Hebrew, locale text support is detected and determined
...
display of Hebrew from left to right.

**5482 Provide a control to switch "write mode"**

When the 'Bidirectional Data ' option is set, the key combination 'Alt +
Shift' will switch the writing mode to Between “L2R” and “R2L”:

The indicator '<' will appear on right of the status line. All text
...
input reaches the start of the field, it remains there.

**5481 New “BiDirectional” Option**
...
Left” option of modification 5477.
