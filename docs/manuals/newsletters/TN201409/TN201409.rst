...
|image4| *Fig. 4 Print data displayed in second browser window.*
...
|image6| *Fig 4 - CEDA of LU T1 printer definition used by Virtel*
...
|image7| *Fig. 5 - Virtel Transaction Detail for CICS transaction*
...
|image8| *Fig. 6 - The Virtel Application Menu Screen*
...
|image9| *Fig. 7 - Processing a PDF File*
...
|image10| *Fig. 8 - 3270 LU with relay printer REHIP000*
...
|image11| *Fig. 9 - GDDM Print Queue*
...
|image12| *Fig. 10 - Print request ready for processing*
...
|image13| *Fig. 11 - Second Browser window containing print. LU3 behaviour*
...
|image14| *Fig. 2 - Multi-Page PDF listing using MAKEPDF*
...
|image15| *Fig. 3 - Setting the transaction option*

We press the “Spanner” icon on the right to create and validate the
relevant files.

|image16| *Fig. 4 - Creating and Validating the Option files*
...
|image17| *Fig. 5 - Creation a transaction for the option directory*
...
|image19| *Fig. 19 - Full screen kiosk display with Chrome*
...
::
	...
	*    
	...
	COPY£ LIST-TO-VARIABLE, For VIRTEL 4.47+   * 
	VAR='RESPONSE',TYPE=REPLACE,   * 
	LIST=(STRING,'<html><head><title>SCENFLND error</title></head><body>',
	VARIABLE,'ERRMSG',   * 
	STRING,'</body></html>')   
	CONVERT£ EBCDIC-TO-ASCII,VAR='RESPONSE'   
	SENDHTML EQU *    
