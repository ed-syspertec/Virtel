...
Login to the Syspertec file server `http://ftp.syspertec.com <http://ftp.syspertec.com/>`__ using the userid and password supplied to you by Syspertec. Navigate to the “Public” – “VIRTEL 4.61” – “Products” folder and download the virtel461mvs.zip file. Unzip this file into a folder on your workstation.
