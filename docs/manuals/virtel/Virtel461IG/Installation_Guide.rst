...
.. _Virtel461IG_Summary_Of_Ammendments:
...
::
  ...
  VIRRW01I INITIALISATION FOR lin2name (MQI-XX ), VERSION 4.61
  ...
  * *****************************************************************
  ...
  // EXEC IDCAMS,SIZE=AUTO
    ...
    INDEX (NAME (VIRTEL.SWAP.INDEX )) -
      CATALOG (VSESP.USER.CATALOG )    IF LASTCC NE 0 THEN CANCEL JOB
  /*
...
.. _#_V461IG_ufile1_to_ufile20_parameters:     
...
VSAMTYP=READONLY takes effect only if the appropriate values have been specified in the MACRF parameter of the ACB (see :ref:`“Additional parameters for VSAM files”, <#_V461IG_additional_parameters_for_VSAM_files>`): and in the MODE subparameter of the UFILEx parameter of the VIRTCT (see :ref:`“UFILE1 to UFILE20", <#_V461IG_ufile1_to_ufile20_parameters>`).
...
.. _#_V461IG_additional_parameters_for_VSAM_files:  
...
For more detailed informations on this subject, see :ref:`“UFILE1 to UFILE20", <#_V461IG_ufile1_to_ufile20_parameters>` and also :ref:`“Additional parameters for VSAM files”, <#_V461IG_additional_parameters_for_VSAM_files>`.
