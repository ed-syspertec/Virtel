...
.. _VVRRIG60_Summary_Of_Ammendments:
...
Login to the Syspertec file server `https://ftp-group.syspertec.com <https://ftp-group.syspertec.com/>`__ using the userid and password supplied to you by Syspertec. Navigate to the “Public” – “VIRTEL 4.60” – “Products” folder and download the virtel460mvs.zip file. Unzip this file into a folder on your workstation.
...
::
  ...
  VIRRW01I INITIALISATION FOR lin2name (MQI-XX ), VERSION 4.60
...
FILE
  Messages will be written to the DDNAMEs LOGFILEx|y               (Virtel 4.60)	
