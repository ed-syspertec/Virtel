...
=======================================================
Audit, Administration, Operations and Performance V4.64
=======================================================
...
Example::
    ...
    F VIRTEL,LINES                                     
    VIR0200I LINES                                      
    VIR0201I VIRTEL 4.64 APPLID=VIRTEL  LINES          
...
Memory Display feature is activated by using the MEMHST subparameter in the MEMORY parameter present in the VIRTCT.(see the VIRTCT subparameter MEMHST in “VIRTEL464 Installation User Guide”).
...
The RELAYS command displays the VIRTEL ACB name and a list of the relay LUs opened by VIRTEL. Foe example::
    ...
    F VIRTEL,RELAYS                                         
    VIR0200I RELAYS                                           
    VIR0214I ACTIVE RELAY ACBS FOR VIRTEL 4.64 APPLID=APPLHOLT
...
::
    ...
    VIR0018I VIRTEL 4.64 HAS THE FOLLOWING PTF(S) APPLIED
...
.. _#_V464AP_correspondent_management:
...
- a correspondent may be authorized to upload HTML pages and other elements into an HTMLTRSF file. For further details, refer to :ref:`“Uploading pages by SMTP” <#_V464AP_http_uploading_pages_smtp>` and :ref:`“Uploading pages by HTTP (secured by cookie)” <#_V464AP_http_uploading_pages>`.
...
.. _#_V464AP_web_entity_management:
...
.. _#_V464AP_http_uploading_pages_signon:
...
uplbas
    external name of the upload transaction in VIRTEL which specifies the target directory (HTMLBAS). See :ref:`“Uploading pages by HTTP (secured by signon)” <#_V464AP_http_uploading_pages_signon>` for a list of upload transactions.
...
.. _#_V464AP_http_uploading_pages_smtp:    
...
1. Activate the e-mail correspondent: see “Account activation” under the heading :ref:`“Correspondent Management” <#_V464AP_correspondent_management>`. This triggers the sending of an e-mail containing the security code, as in the following example:-
...
.. _#_V464AP_http_uploading_pages:
...
1. (First time only) Activate the e-mail correspondent: see :ref:`“Account activation” <#_V464AP_account_activation>`. This triggers the sending of an e-mail containing the security code, as in the following example:
...
::
    ...
    W-HTTP WHT00200 DEVTA003 I 15.34.53 15.34.62 00000649 00001169 00010397 192.168.000.043 PUBLIC WEB2VIRT W2H-10
...
::
    ...
    00080 99898440 4B404B40 4B404B29 0241F442 F5114BF1 1DF0114B F4290242 F4C0F0C7 *rid . . . ....4.5..1.0..4...4é0G* 099A9644
...
::   
    ...
    00020 42050653 59535041 53060102 07030024 02160102 17010164 6E434654 20593D4D *B..SYSPAS......$.......cnCFT Y=M* 0989119C
    00040 2C443D32 30303530 31303531 33343831 3536402C 564D3233 302C5A3D 702D312D *,D=2005010513481560,V=230,Z=p-1-* 098911BC
...
The SNAPMSG command requests VIRTEL to generate an automatic SNAP after certain messages (VIRI902W, VIR0026W, VIR0052I, VIR1552I, VIR0526W or VIR1952I).Only one SNAP can also be obtained with user specific code provided by SYSPERTEC for messages VIRHT31E and VIRHT64E. See “VIRTEL commands”. See the SNAPMSG command for further details.
...
::
    ...
    **Position    Format          Type of information**
    ...
    64 to 70    Alphanumeric    Minitel: Server access node
...
::
    ...
    64 to 70        Alphanumeric    Originating GATE/PCNE terminal name (outbound)
