...
=======================================================
Audit, Administration, Operations and Performance V4.60
=======================================================
...
The RELAYS command displays the VIRTEL ACB name and a list of the relay LUs opened by VIRTEL. Foe example::
    ...
    F VIRTEL,RELAYS                                         
    VIR0200I RELAYS                                           
    VIR0214I ACTIVE RELAY ACBS FOR VIRTEL 4.60 APPLID=APPLHOLT
...
::
    ...
    VIR0018I VIRTEL 4.60 HAS THE FOLLOWING PTF(S) APPLIED
...
.. _#_V460AP_correspondent_management:
...
- a correspondent may be authorized to upload HTML pages and other elements into an HTMLTRSF file. For further details, refer to :ref:`“Uploading pages by SMTP” <#_V460AP_http_uploading_pages_smtp>` and :ref:`“Uploading pages by HTTP (secured by cookie)” <#_V460AP_http_uploading_pages>`.
...
.. _#_V460AP_web_entity_management:
...
.. _#_V460AP_http_uploading_pages_signon:
...
uplbas
    external name of the upload transaction in VIRTEL which specifies the target directory (HTMLBAS). See :ref:`“Uploading pages by HTTP (secured by signon)” <#_V460AP_http_uploading_pages_signon>` for a list of upload transactions.
...
.. _#_V460AP_http_uploading_pages_smtp:    
...
1. Activate the e-mail correspondent: see “Account activation” under the heading :ref:`“Correspondent Management” <#_V460AP_correspondent_management>`. This triggers the sending of an e-mail containing the security code, as in the following example:-
...
.. _#_V460AP_http_uploading_pages:
...
1. (First time only) Activate the e-mail correspondent: see :ref:`“Account activation” <#_V460AP_account_activation>`. This triggers the sending of an e-mail containing the security code, as in the following example:
